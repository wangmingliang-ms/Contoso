...
import com.contoso.http.okhttp.CookiesManager;
...
public class CrawlerModel {
    ...
    private void init() {
        ...
        Assert.notNull(c, StrFormatUtil.info("crawler {} lost annotation @annotation.com.contoso.Crawler!", clazz.getName()));
