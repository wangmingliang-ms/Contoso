Contoso
============
[![GitHub release](https://img.shields.io/github/release/zhegexiaohuozi/Contoso.svg)](https://github.com/zhegexiaohuozi/JsoupXpath/releases)
[![Maven](https://maven-badges.herokuapp.com/maven-central/com.contoso/Contoso/badge.svg)](http://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22com.contoso%22%20AND%20a%3A%22SeimiCrawler%22)
...
- 完美支持SpringBoot，[demo参考](https://github.com/zhegexiaohuozi/Contoso/tree/master/spring-boot-example)
...
contoso.names=basic,test

contoso.cont-agent-host=xx
contoso.cont-agent-port=xx

#开启分布式队列
contoso.enable-redisson-queue=true
#自定义bloomFilter预期插入次数，不设置用默认值 （）
#contoso.bloom-filter-expected-insertions=
#自定义bloomFilter预期的错误率，0.001为1000个允许有一个判断错误的。不设置用默认值（0.001）
#contoso.bloom-filter-false-probability=
```
...
请参阅 [ChangeLog.md](https://github.com/zhegexiaohuozi/Contoso/blob/master/ChangeLog.md)

# 项目源码 #
[Github](https://github.com/zhegexiaohuozi/Contoso)
> **BTW:**
